...
def ensure_active_user(user_id: str, email: str | None = None) -> None:
    # Registration no longer has an invitation-code activation gate. Keep this
    # boundary as a lightweight identity reconciliation step so existing route
    # code can continue to ensure the business user row exists before job I/O.
