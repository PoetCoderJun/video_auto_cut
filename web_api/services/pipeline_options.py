...
def build_pipeline_options(**overrides: object) -> PipelineOptions:
    ...
    values = {
        ...
        "qwen3_progress_chunk_s": settings.qwen3_progress_chunk_s,
        "qwen3_correct": settings.qwen3_correct,
        "qwen3_correct_max_diff_ratio": settings.qwen3_correct_max_diff_ratio,
