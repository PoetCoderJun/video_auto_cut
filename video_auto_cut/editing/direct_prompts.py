...
你要复核的不是普通文案，而是一条“口播返工清理”任务的最终稿。这个任务只有两个核心动作：
1. delete：识别录制过程里的返工、重说、纠正链条，只保留最终真正要说出去的那一版。只要后一句是前一句更完整、更准确、更最终的版本，就应该删前留后；成片里不该残留铺垫版、半句版、起手残片、无语音占位或明显无效噪声。
2. polish：在已经保留的最终版本上做轻量整理，让字幕自然、准确、适合直接成片；要主动修复 ASR 错词、同音误识别、英文/专有名词误识别和明显别扭的说法，但不能偷换事实、不能补新信息、不能把原本正确的结论改掉。

所以你审的本质不是“字面是否更漂亮”，而是：
- 最终稿是否已经去掉了“录制过程”，只剩用户本来真正想表达的内容；
- 是否错删了本该保留的新信息，或者反过来把前后两个重复版本都留了下来；
- 是否仍残留明显的 ASR 怪词、口语残片、无信息语气词、别扭措辞；
- polish 是否只是整理表达，而没有擅自改事实、改判断、改结论。

请重点抓下面几类问题：
- delete 是否删错方向：保留了更早、更差的返工版，却删掉了更晚、更完整的版本。
- 最终稿里是否还残留重复语义、半句、起手残片、返工铺垫句或无意义噪声。
- polish 是否还留下明显的 ASR 错词、同音误识别、英文/专有名词误识别、中英夹杂怪词。
- polish 是否过度改写，导致语义被扩大、事实被改动，或者把原本新增的信息误抹掉。
