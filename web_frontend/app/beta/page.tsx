  ...
  return (
    <div className="min-h-screen bg-background font-sans text-foreground">
      <header className="border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container mx-auto flex h-12 items-center justify-between px-3 sm:h-16 sm:px-6">
          <Link
            href="/"
          ...
          <div className="flex items-center gap-1.5 sm:gap-3">
            <Link href="/sign-in">
              <Button variant="ghost" className="h-8 rounded-full px-3 text-xs sm:h-10 sm:px-4 sm:text-sm">
                登录
              </Button>
            </Link>
            <Link href="/sign-up">
              <Button className="h-8 rounded-full px-3 text-xs sm:h-10 sm:px-5 sm:text-sm">注册</Button>
            </Link>
          </div>
        </div>
      </header>

      <main className="container mx-auto px-3 py-2 sm:flex sm:min-h-[calc(100svh-4rem)] sm:items-center sm:px-6 sm:py-6">
        <div className="w-full space-y-3 sm:space-y-4">
          ...
          <section className="grid gap-3 sm:gap-4 lg:grid-cols-[1fr_1.06fr]">
