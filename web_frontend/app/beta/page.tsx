      ...
      <header className="border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container mx-auto flex h-16 items-center justify-between px-4 sm:px-6">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <Link href="/sign-up">
              <Button className="rounded-full px-5">注册</Button>
            </Link>
          </div>
        </div>
      </header>

      <main className="container mx-auto flex min-h-[calc(100svh-4rem)] items-center px-4 py-4 sm:px-6 sm:py-6">
          ...
          <section className="grid gap-4 lg:grid-cols-[1fr_1.06fr]">
            <div className="rounded-2xl border border-border bg-card shadow-sm">
              <div className="space-y-4 p-4 sm:p-5">
                <h2 className="text-xl font-semibold text-foreground">添加微信</h2>
            ...
            <div className="rounded-2xl border border-border bg-card shadow-sm">
              <div className="space-y-4 p-4 sm:p-5">
                <h2 className="text-xl font-semibold text-foreground">给内测用户的一封信</h2>
                <div className="space-y-3 text-sm leading-8 text-muted-foreground sm:text-base sm:leading-8">
